...
3. **Плейлист из выделенных файлов TC** — FindWindowEx не находит ListView TC
...
**Проблема:** FindWindowEx для поиска SysListView32 в TC не находит ListView.

**Возможные решения:**
1. EnumChildWindows с рекурсивным поиском
2. Clipboard approach: отправить cm_CopyFullNamesToClip → прочитать clipboard
3. Оригинал использует другой механизм
